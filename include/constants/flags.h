...
//More Hidden Items
#define FLAG_HIDDEN_ITEM_ROUTE_101_POTION  					  (FLAG_HIDDEN_ITEMS_START + 0x60)
...
#define FLAG_VISITED_OMIRE_ISLAND                   (SYSTEM_FLAGS + 0x21) // Unused Flag
...
//Quest Flags
#define FLAG_ROUTE104_QUEST_COMPLETED               (SYSTEM_FLAGS + 0x85) 
#define FLAG_DEWFORD_QUEST_COMPLETED                (SYSTEM_FLAGS + 0x86) 
